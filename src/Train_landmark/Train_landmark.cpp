...
int main(int argc, char** argv)
{
	try
	{
		...
		const std::string faces_directory = "C:\\Users\\zhumingde\\Desktop\\²É¼¯\\palm";
		...
		load_image_dataset(images_train, faces_train, faces_directory + "\\train_new.xml");
		load_image_dataset(images_test, faces_test, faces_directory + "\\train_new.xml");
		...
		trainer.set_oversampling_amount(300);//300
